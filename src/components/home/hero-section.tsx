  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      >
        ...
        >
          Create Solana Meme Coins In Seconds
        </motion.h1>
        ...
        >
          The easiest way to mint, launch, and manage meme coins on the Solana
          blockchain. No coding required.
        </motion.p>
        ...
        >
          Trusted by hundreds of meme coin creators on Solana
        </motion.div>
      </motion.div>
    </section>
  );
