...
export default function TokenDetailView({ token, onClose }: TokenDetailViewProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="relative bg-[#171717] rounded-xl shadow-xl border border-gray-800 max-w-2xl w-full max-h-[90vh] overflow-hidden">
        {/* Header */}
          ...
          {activeTab === 'details' && (
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-purple-900/20 to-blue-900/20 flex items-center justify-center">
