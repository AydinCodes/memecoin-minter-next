...
export default function CopyButton({
  ...
  return (
    <div className="relative inline-flex items-center hover:cursor-pointer" onClick={handleCopy}>
      <button
      ...
      >
        <svg
          className="w-5 h-5 hover:bg-[#6b46c1]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
      ...
      <div className={`copy-success ${copied ? "show" : ""}`}>Copied!</div>
    </div>
  );
}
